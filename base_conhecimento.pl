...
perfil(ciencia_de_dados, logica, 2).
perfil(ciencia_de_dados, design_virtual, 1).
...
perfil(inteligencia_artificial, matematica_estatistica, 2).
perfil(inteligencia_artificial, design_virtual, 1).
...
perfil(desenvolvimento_web, logica, 2).
...
perfil(seguranca_da_informacao, logica, 1).
